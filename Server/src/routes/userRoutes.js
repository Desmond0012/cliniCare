...
import { rateLimiter, refreshTokenLimiter } from "../middlewares/rateLimit.js";
...
router.get("/all", verifyAuth, authorizedRoles("admin", "doctor", "staff", "nurse"), 
cacheMiddleware("users", 3600), getAllUsers);
