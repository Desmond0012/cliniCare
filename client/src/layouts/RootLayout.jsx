...
export default function RootLayout() {
 ...
 <ul className=" hidden     md:flex justify-center items-center gap-[64px]   ">
  <li className="cursor-pointer">Features</li>
   <a href="#how-it-works"><li className="cursor-pointer">How It Works</li></a>
    <li >Contact Us</li>
 </ul>
  ...
  className="  rounded-md py-1 px-2 md:py-[18px] md:px-[18px] text-[#FFFCFC]  font-bold  md:font-semibold   md:text-[20px]  bg-[#2465FF]"
  ...
  Get Started
      ...
      <div className="container mt-50 mx-auto py-5 px-4  ">
        ...
        <div className="flex items-center">
          <p className="md:text-[24px] font-bold text-white ">Copyright</p>
          <RiCopyrightFill size={18} className="text-white" />
          <span className="md:text-[24px] font-bold text-white ">
