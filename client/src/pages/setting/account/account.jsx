...
export default function Account() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-bold text-2xl border-b boarder-gray-300 pb-2">Account</h1>
      <>
        <UploadImage/>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 lg:grid grid-cols-12"
          id="/dashboard/settings/account"
          >
            {error && <ErrorAlert error={error}/>}
            <div className="col-span-6 w-fu">
          ...
          <div className="border-t border-gray-300 pt-4 mt-4 ">
            ...
            <div className="flex md:flex-row flex-col gap-4 justify-between items-center" >
              <p className="md:w-md">When you delete your account, you loose access to medical history and appointments. We permanently delete your account and all associated data.</p>
                <DeleteAccount/>
            </div>
          </div>
      </>
